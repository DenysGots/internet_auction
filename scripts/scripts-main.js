...
function main(){ 
	...
	var lotPageTemplate = 
		...
		'<h1 class="heading_1 lot-page_title">' +
			'Англия. Георг VI. 1 шиллинг 1945 года.' +
		'</h1>' + 
		
		'<div class="lot-page_information">' +
			'<div class="lot-page_images-window">' + 
				'<div class="lot-page_main-image-window">' +
					'<img src="../images/coin-1-1.jpg" alt="" class="lot-page_main-image">' + 
				'</div>' +
				
				'<div class="lot-page_image-preview-window">' +
					'<div class="lot-page_image-preview">' +
						'<img src="../images/coin-1-1.jpg" alt="" class="lot-page_image-preview_image image-1">' +
					'</div>' +
					
					'<div class="lot-page_image-preview">' +
						'<img src="../images/coin-1-2.jpg" alt="" class="lot-page_image-preview_image image-2">' +
					'</div>' +
				'</div>' +
			'</div>' +
	...
	var lotPreviewTemplate = 	
		'<div class="main-page_lot_image-window">' +    
			'<img src="../images/coin-1-1.jpg" alt="" class="main-page_lot-image">' +    
		'</div>' +   
...
/* 			function timer() {
	...
	function createLotsPreviews() {
		...
		function addStandartLotAttributes(elem) {
			...
			elem.setAttribute("data-сountry-of-origin", initialContent[i].сountry_of_origin);
			elem.setAttribute("data-year-of-manufacture", initialContent[i].year_of_manufacture);
			elem.setAttribute("data-material", initialContent[i].material);
		}; 
...
/* 		var currenContentPreviewPage = 1; 
		...
		Array.prototype.slice.call(lotsPreviews).forEach(function(obj){
			if (obj.getAttribute("data-current-preview-page") > 1) {
				hideElements(obj); 
			}; 
		});
		
		Array.prototype.slice.call(lotsPreviewsPages).forEach(function(obj){
			obj.addEventListener("click", function(e) {

				currenContentPreviewPage = obj.getAttribute("data-current-preview-page"); 
				
				if (obj.getAttribute("data-current-preview-page") !== currenContentPreviewPage) {
					hideElements(obj);
				} else {
					showElements(obj);
				}; 
